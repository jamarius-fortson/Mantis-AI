...
from app.graphs.orchestrator import create_mantis_graph
...
app = FastAPI(
    title="Mantis Enterprise API", 
    description="Distributed Agentic Marketing Intelligence System", 
    version="2.0.0"
)
...
async def health_check():
    return {"status": "online", "system": "Mantis"}
